...
void setup() {
    ...
    Terminal.Text(27, 117, RED, String(Energy_Analyzer.Get_Bucket_L(), HEX));
    Terminal.Text(28, 117, RED, String(Energy_Analyzer.Get_Bucket_H(), HEX));

    Terminal.Text(20, 151, RED, String(Energy_Analyzer.Get_VSCale()));
    Terminal.Text(21, 151, RED, String(Energy_Analyzer.Get_ISCale()));

    Terminal.Text(33, 15, RED, String(Energy_Analyzer.Get_Limit(__VIMB_MAX__),2));
    Terminal.Text(33, 27, RED, String(Energy_Analyzer.Get_Limit(__IIMB_MAX__),2));
    Terminal.Text(33, 39, RED, String(Energy_Analyzer.Get_Limit(__VRMS_MIN__),2));
    Terminal.Text(33, 50, RED, String(Energy_Analyzer.Get_Limit(__VRMS_MAX__),2));
    Terminal.Text(33, 61, RED, String(Energy_Analyzer.Get_Limit(__VSAG_LIM__),2));
    Terminal.Text(33, 72, RED, String(Energy_Analyzer.Get_Limit(__IRMS_MAX__),2));
    Terminal.Text(33, 83, RED, String(Energy_Analyzer.Get_Limit(__PF_MIN__),2));
    Terminal.Text(33, 91, RED, String(Energy_Analyzer.Get_Limit(__T_MIN__),2));
    Terminal.Text(33, 99, RED, String(Energy_Analyzer.Get_Limit(__T_MAX__),2));
    Terminal.Text(33, 107, RED, String(Energy_Analyzer.Get_Limit(__F_MIN__),2));
    Terminal.Text(33, 116, RED, String(Energy_Analyzer.Get_Limit(__F_MAX__),2));
...
void loop() {
    ...
    if (Energy_Analyzer.Get_Sticky()) {Terminal.Text(25, 120, CYAN, "X");} else {Terminal.Text(25, 120, CYAN, "-");}
	...
	if (Serial.available() > 0) {
		...
		case 'Q':
			...
			// Set Sticky
			Energy_Analyzer.Set_Sticky(false);

			break;
		case 'W':

			// Set Sticky
			Energy_Analyzer.Set_Sticky(true);
